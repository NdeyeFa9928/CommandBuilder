...
class TestArgumentComponentInitialization:
    ...
    def test_initialization_with_argument(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
...
class TestArgumentComponentGetValue:
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_get_value_returns_text(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_get_value_returns_empty_when_no_line_edit(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
...
class TestArgumentComponentSetValue:
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_set_value_updates_line_edit(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_set_value_does_nothing_when_no_line_edit(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
...
class TestArgumentComponentGetArgument:
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_get_argument_returns_argument(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
...
class TestArgumentComponentBrowseButton:
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_enable_browse_button_shows_button(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_enable_browse_button_hides_button(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_enable_browse_button_does_nothing_when_no_button(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
...
class TestArgumentComponentSignals:
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    def test_value_changed_signal_emitted(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
...
class TestArgumentComponentBrowseDialog:
    ...
    @patch.object(ArgumentComponent, '_load_stylesheet')
    @patch.object(ArgumentComponent, '_setup_ui')
    @patch('command_builder.components.argument_component.argument_component.QFileDialog.getOpenFileName')
    def test_browse_clicked_sets_file_path(self, mock_file_dialog, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
    ...
    @patch.object(ArgumentComponent, '_setup_ui')
    @patch('command_builder.components.argument_component.argument_component.QFileDialog.getOpenFileName')
    def test_browse_clicked_does_nothing_when_cancelled(self, mock_file_dialog, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
    ...
    @patch.object(ArgumentComponent, '_setup_ui')
    @patch('command_builder.components.argument_component.argument_component.QFileDialog.getOpenFileName')
    def test_browse_clicked_does_nothing_when_no_line_edit(self, mock_file_dialog, mock_setup, mock_stylesheet, mock_ui, qapp, sample_argument):
