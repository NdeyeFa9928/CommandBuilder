...
class TestCommandComponentBuildFullCommand:
    ...
    def test_build_full_command_no_arguments(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_no_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_build_full_command_with_empty_arguments(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_with_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_build_full_command_with_filled_arguments(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_with_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_build_full_command_with_partial_arguments(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_with_args):
...
class TestCommandComponentUpdateCommandDisplay:
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_update_command_display_no_label(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_no_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_update_command_display_simple_mode(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_no_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_update_command_display_full_mode(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_no_args):
...
class TestCommandComponentIntegration:
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_argument_change_updates_display(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_with_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_clear_arguments_resets_display(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_with_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_get_argument_values_returns_all_values(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_with_args):
    ...
    @patch.object(CommandComponent, '_load_stylesheet')
    @patch.object(CommandComponent, '_setup_ui')
    def test_set_argument_value_updates_component(self, mock_setup, mock_stylesheet, mock_ui, qapp, sample_command_with_args):
