...
class MainWindow(QMainWindow):
    ...
    def _load_ui(self):
        ...
        self.pipeline_list_container = self.findChild(QMainWindow, "pipelineListContainer")
        self.command_form_container = self.findChild(QMainWindow, "commandFormContainer")
        self.console_output_container = self.findChild(QMainWindow, "consoleOutputContainer")
    ...
    def _setup_components(self):
        ...
        if self.pipeline_list_container:
            ...
            self.pipeline_list_container.setLayout(layout)
        ...
        if self.command_form_container:
            ...
            self.command_form_container.setLayout(layout)
        ...
        if self.console_output_container:
            ...
            self.console_output_container.setLayout(layout)
    ...
    def _connect_signals(self):
        ...
        if self.pipeline_list and self.command_form:
    ...
    def _on_command_selected(self, pipeline_name, command_name):
        ...
        if self.console_output:
            self.console_output.append_text(f"Commande sélectionnée: {pipeline_name} - {command_name}")
        
        # À implémenter: charger la commande dans le formulaire
        # self.command_form.set_command(...)
