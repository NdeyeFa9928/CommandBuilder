...
class MainWindow(QMainWindow):
    ...
    def _load_ui(self):
        ...
        self.task_list_container.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        command_form_container.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        console_output_container.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        self.main_splitter.setStretchFactor(1, 3)  # Zone de droite (CommandForm + Console)
