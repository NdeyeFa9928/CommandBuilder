...
import datetime
from PySide6.QtWidgets import QWidget, QVBoxLayout, QPlainTextEdit, QPushButton, QFileDialog
...
class ConsoleOutput(QWidget):
    ...
    def export_console(self):
        ...
        default_filename = f"console_output_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
